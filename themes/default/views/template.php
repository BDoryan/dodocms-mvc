...
<!--            <resources-selector-modal :resources="--><?php //= Tools::parseJsonToHtmlAttribute(json_encode(ResourceModel::findAll('*'), JSON_HEX_QUOT)) ?><!--" :ref="`ref_resources_selector_modal`"></resources-selector-modal>-->
