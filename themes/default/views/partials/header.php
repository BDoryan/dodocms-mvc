    ...
    <div class="container">
        <div class="relative -mx-4 flex items-center justify-between">
            <div class="w-60 max-w-full px-4">
                <a href="/" class="navbar-logo block w-full py-5 flex">
                    <img
                    ...
                    <span class="flex flex-col pl-3 ">
                        <span class="text-3xl my-auto font-bold leading-snug text-white hover:text-white lg:leading-[1]">DodoCMS</span>
                        <span class="text-sm italic text-gray-200 text-nowrap"><?= DodoCMS::VERSION ?? 'version_not_found' ?></span>
                    </span>
                </a>
            </div>
