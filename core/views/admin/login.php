<div class="dodocms-min-h-screen dodocms-flex dodocms-flex-col dodocms-items-center dodocms-justify-center dodocms-p-4 dodocms-bg-gradient-to-br from-violet-300 via-violet-200 to-violet-200">
    <div class="backdrododocms-p-filter backdrododocms-p-dodocms-blur-lg dodocms-bg-opacity-50 dodocms-border dodocms-border-black dodocms-border-opacity-20 dodocms-bg-white dodocms-p-8 dodocms-rounded-3xl dodocms-shadow-lg dodocms-w-full md:dodocms-w-4/5 lg:dodocms-w-4/5 xl:dodocms-w-2/6">
        <div class="dodocms-text-center">
            <img class="dodocms-mx-auto dodocms-mb-5" width="110" height="110" src="<?= Application::get()->toURL("/core/assets/imgs/logo.png") ?>">
            ...
            <form class="dodocms-text-start dodocms-flex dodocms-flex-wrap dodocms-mt-1" action="<?= Tools::getCurrentURI(); ?>" method="POST"><h2
