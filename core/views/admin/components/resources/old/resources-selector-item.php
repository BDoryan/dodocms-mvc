<form class="dodocms-relative dodocms-h-full resource-item" method="POST">
    <div class="dodocms-h-full dodocms-rounded-lg dodocms-border-gray-300 dodocms-border-opacity-25" style="min-width: 500px; height: 200px;">
