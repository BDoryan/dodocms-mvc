        ...
        <div class="dodocms-text-center">
            ...
            <form class="dodocms-text-start dodocms-flex dodocms-flex-wrap dodocms-mt-1"
                ...
                <div class="dodocms-mb-4 dodocms-w-full dodocms-px-2">
                    <?php
                    Text::create()->template('/core/admin/views/components/field/')->label(__('admin.login.form.username'))->name("email")->placeholder(__('admin.login.form.your_username'))->required()->render()
                    ?>
                </div>
                <div class="dodocms-mb-4 dodocms-w-full dodocms-px-2">
                    <?php
                    Text::create()->template('/core/admin/views/components/field/')->type("password")->label(__('admin.login.form.password'))->name("password")->placeholder(__('admin.login.form.your_password'))->required()->render()
                    ?>
                </div>
