        ...
        <div id="attributes-container" class="dodocms-flex dodocms-flex-col dodocms-gap-y-3">
            <?php if (!empty($table) && !empty($table->getAttributes())): ?>
                <?php foreach ($table->getAttributes() as $attribute):
                    ...
                    view(Application::get()->toRoot("/core/admin/views/panel/sections/table/attribute/attribute.php"), ["attribute" => $attribute]);
                endforeach; ?>
            <?php else: ?>
                <?php view(Application::get()->toRoot("/core/admin/views/panel/sections/table/attribute/attribute.php")) ?>
            <?php endif; ?>
        </div>
