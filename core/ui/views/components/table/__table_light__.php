<div class="tw-border-gray-500 tw-border-opacity-25 tw-rounded-lg tw-border-[1px] tw-overflow-x-auto tw-drop-shadow-md tw-text-gray-600 tw-bg-white tw-bg-opacity-70 ">
        ...
        if (!empty($this->rows)) {
            ...
            <tr>
                <td colspan="<?= count($this->columns) ?>"
                    class="tw-text-xl tw-text-center tw-py-5 tw-border-gray-500 tw-border-opacity-25 tw-rounded-b-lg"><?= __("components.table.rows.empty") ?></td>
            </tr>
            <?php
        }
        ?>
