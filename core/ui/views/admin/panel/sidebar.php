...
<div class="tw-flex-shrink-0 tw-w-64 tw-backdrop-filter tw-backdrop-blur-lg tw-bg-opacity-50 tw-border tw-border-black tw-border-opacity-20 tw-bg-white tw-rounded-2xl tw-overflow-hidden  tw-shadow-sm">
    <div class="tw-flex tw-flex-col tw-h-full">
        ...
        <div class="tw-px-3 tw-text-center italic tw-py-2 tw-text-md tw-font-semibold tw-bg-white tw-bg-opacity-50 tw-shadow-sm tw-text-gray-700 tw-flex tw-flex-col">
            <p><?= DodoCMS::VERSION ?></p>
            <?php if (Application::get()->hasUpdate()) { ?><a href="<?= NativeRoutes::getRoute(NativeRoutes::ADMIN_PANEL) ?>" class="tw-my-2 tw-text-red-500 tw-font-bold tw-text-sm tw-italic tw-underline">Nouvelle version disponible</a><?php } ?>
        </div>
    </div>
</div>